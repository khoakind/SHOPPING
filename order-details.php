								...
								<table class="table table-bordered">
									<thead>
										<tr>
											...
											<th class="cart-total item">Tổng Giá</th>
											<th class="cart-total item">Phương Thức Thanh Toán</th>
											<th class="cart-description item">Thời Gian</th>
										...
										?>
												<tr>
													...
													<td class="cart-image">
														...
														<img src="admin/productimages/<?php echo $row['proid'];?>/<?php echo $row['pimg1'];?>" alt="" width="180px" height="180px">
													</td>
											...
											<tr>
												<td colspan="8">ID đơn đặt hàng hoặc Email đã đăng ký đều không hợp lệ</td>
											</tr>
										<?php } ?>
									</tbody><!-- /tbody -->
								</table><!-- /table -->
