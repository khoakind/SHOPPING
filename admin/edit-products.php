...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$_SESSION['msg'] = "Sản Phẩm Cập Nhật Thành Công !";
	}
								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										?>
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Thương Hiệu</label>
												<div class="controls">
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Giá Cũ</label>
												<div class="controls">
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Giá Mới</label>
												<div class="controls">
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Thông Tin</label>
												<div class="controls">
...
<?php echo htmlentities($row['productDescription']); ?>
											...
											<div class="control-group">
												...
												<div class="controls">
													<img src="productimages/<?php echo htmlentities($pid); ?>/<?php echo htmlentities($row['productImage1']); ?>" width="200" height="100"> <a href="update-image1.php?id=<?php echo $row['id']; ?>">Sửa Ảnh</a>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<img src="productimages/<?php echo htmlentities($pid); ?>/<?php echo htmlentities($row['productImage2']); ?>" width="200" height="100"> <a href="update-image2.php?id=<?php echo $row['id']; ?>">Sửa Ảnh</a>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<img src="productimages/<?php echo htmlentities($pid); ?>/<?php echo htmlentities($row['productImage3']); ?>" width="200" height="100"> <a href="update-image3.php?id=<?php echo $row['id']; ?>">Sửa Ảnh</a>
												</div>
											</div>
										<?php } ?>
										<div class="control-group">
