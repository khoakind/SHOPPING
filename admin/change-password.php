								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="chngpwd" method="post" onSubmit="return valid();">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="password" placeholder="" name="password" class="span8 tip" required>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="password" placeholder="" name="newpassword" class="span8 tip" required>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="password" placeholder="" name="confirmpassword" class="span8 tip" required>
											</div>
										</div>
