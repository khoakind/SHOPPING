...
if (strlen($_SESSION['alogin']) == 0) {
  ...
  if (isset($_POST['submit2'])) {
    ...
    echo "<script>alert('Đã cập nhật đơn hàng thành công ...');</script>";
    //}
  }
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr height="50">
            <td colspan="2" class="fontkink2" style="padding-left:0px;">
              <div class="fontpink2"> <b>Xác Nhận Đơn Hàng</b></div>
            </td>
          ...
          if ($st == $currrentSt) { ?>
            ...
            <tr>
              ...
              <td class="fontkink"> <input type="submit" name="submit2" value="Lưu" size="40" style="cursor: pointer;" /> &nbsp;&nbsp;
