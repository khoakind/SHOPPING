...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_GET['del'])) {
		...
		$_SESSION['delmsg'] = "Sản Phẩm Đã Được Xoá!";
	}
											...
											?>
												<tr>
													...
													<td>
														...
														<a href="manage-products.php?id=<?php echo $row['id'] ?>&del=delete" onClick="return confirm('Bạn có muốn xoá sản phẩm không?')"><i class="icon-remove-sign"></i></a>
													</td>
												</tr>
											<?php $cnt = $cnt + 1;
											} ?>
