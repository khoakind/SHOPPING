...
if (strlen($_SESSION['login']) == 0) {
	...
	if (isset($_POST['update'])) {
		...
		$query = mysqli_query($con, "update users set name='$name',contactno='$contactno',shippingAddress='$shippingAddress' where id='" . $_SESSION['id'] . "'");
		if ($query) {
												...
												<div class="col-md-12 col-sm-12 already-registered-login">
													...
													?>
														...
														<form class="register-form" role="form" method="post">
															...
															<div class="form-group">
																<label class="info-title" for="Address">Địa Chỉ (Nơi nhận hàng)<span>*</span></label>
