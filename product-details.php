...
if (isset($_GET['action']) && $_GET['action'] == "add") {
	...
	if (isset($_SESSION['cart'][$id])) {
		...
		if (mysqli_num_rows($query_p) != 0) {
			...
			$_SESSION['cart'][$row_p['id']] = array("size" => $row_p['size']);
...
if (isset($_POST['submit'])) {
	...
	$review = $_POST['review'];
	mysqli_query($con, "insert into productreviews(productId,quality,price,value,name,size,summary,review) values('$pid','$qty','$price','$size','$value','$name','$summary','$review')");
}
                                        ...
                                        <div class="hot-deal-wrapper">
                                            <div class="image">
                                                <img src="admin/productimages/<?php echo htmlentities($rws['id']); ?>/<?php echo htmlentities($rws['productImage1']); ?>"
                                                    width="200" height="335" style="width:100%" alt="">
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="price-box">
                                                <span class="price"><?php echo htmlentities($row['productPrice']); ?>
                                                    VND</span>
                                                <span
                                                    class="price-strike"><?php echo htmlentities($row['productPriceBeforeDiscount']); ?>
                                                    VND</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="size-input">
                                                <select style="width: 70px; height: 35px; border: 1px solid #f2f2f2; font-size: 15px;">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>"
                                                class="btn btn-primary"><i
                                                    class="fa fa-shopping-cart inner-right-vs"></i> Thêm Giỏ Hàng</a>
                                            <?php } else { ?>
                            ...
                            <div class="product-image">
                                <div class="image">
                                    <a href="product-details.php?pid=<?php echo htmlentities($rw['id']); ?>"><img
                                            ...
                                            width="150" height="240" style="width:95%" alt=""></a>
                                </div><!-- /.image -->
